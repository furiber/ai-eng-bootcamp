...
# Derived from this file's location so the copy-paste commands can't drift from
# the real folder name. Quoted because the folder name contains a space.
WORKDIR_CMD = f'"{Path(__file__).resolve().parent.name}"'
ACTIVATE_CMD = (
